<?php /* Smarty version 2.6.22, created on 2014-04-20 17:37:10
         compiled from tpl_list2.html */ ?>
...
<!--排序组-->
	...
	<div class="Sort cd3 cb2A fl">
		...
		<div class="block_add fr"><a>添<br/>加</a></div>
		...
		<?php if ($this->_tpl_vars['Field_']['type']): ?>
				<div class="sortkey switch_sortkey" id="type">
...
"><?php echo $this->_tpl_vars['self_sortkey3'][$this->_sections['list']['index']]; ?>
		...
		<?php if ($this->_tpl_vars['Field_']['feature']): ?>
				<div class="sortkey switch_sortkey" id="feature">
...
<!--列表主体-->	
	<iframe name="tpl_list_" id="tpl_list_" src="manage.php?act=list&col=<?php echo $_GET['col']; ?>
