<?php /* Smarty version 2.6.22, created on 2014-02-24 18:02:14
         compiled from tpl_adminbase.html */ ?>
...
<?php endif; ?>"  method="post" enctype="multipart/form-data" class="long">
			<li><div class="Left">网站名称：</div><div class="Right"><input type="text" name="webname" value="<?php echo $this->_tpl_vars['rsedit']['webname']; ?>
" /></div></li>
			<li><div class="Left">首页title：</div><div class="Right"><input type="text" name="title" value="<?php echo $this->_tpl_vars['rsedit']['title']; ?>
" /></div></li>
