<?php /* Smarty version 2.6.22, created on 2014-04-10 21:41:56
         compiled from tpl_list2_.html */ ?>
...
<body>
	...
	.List form input{ text-align:center;}
	.List form.Input input{ text-align:left;}
	.List ul{ position:relative;}
	.List ul li.last{ text-align:left; text-indent:10px;}
	.List ul li.last input{ background-color:#fff; cursor:pointer;}
	.List .listDel{ position:absolute; right:10px; top:2px; background-color:#fff; cursor:pointer;}
	</style>
...
$this->_sections['hd']['loop'] = is_array($_loop=$this->_tpl_vars['field_list_hd']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
px;"><?php echo $this->_tpl_vars['field_list_hd'][$this->_sections['hd']['index']]; ?>
</li>
			<?php endfor; endif; ?>
...
?>
		<ul class="<?php echo $this->_tpl_vars['list_img']; ?>
">
...
?>
			<li><input style="width:<?php echo $this->_tpl_vars['rsList'][$this->_sections['list']['index']]['width'][$this->_sections['list2']['index']]; ?>
px" type="text" name="<?php echo $this->_tpl_vars['Field_list0'][$this->_sections['list2']['index']]; ?>
