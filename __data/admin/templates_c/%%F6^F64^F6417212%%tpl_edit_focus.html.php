<?php /* Smarty version 2.6.22, created on 2014-02-26 10:22:20
         compiled from tpl_edit_focus.html */ ?>
...
<span class="mark">[ 注：跳转链接与详情中添加链接时请务必在前面加”http://“ ]</span></h3>
	</div><!--ttl003a end-->
...
" /></div></li>
			<li><div class="Left">跳转链接：</div><div class="Right"><input type="text" name="link" value="<?php echo $this->_tpl_vars['rsedit']['link']; ?>
" />如没有特定的网址请空缺,如需设置特定网址请前面务必加http://</div></li>
			<li>
				<div class="Left">图片：</div>
				<div class="Right">
					<input name="pic" type="file" /><?php echo $this->_tpl_vars['rsedit']['pic']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;注：请最好按以下尺寸上传：宽(1000px)，高(350px)； 
