<?php /* Smarty version 2.6.22, created on 2014-02-26 16:01:51
         compiled from tpl_special_seo.html */ ?>
...
&act=<?php if ($this->_tpl_vars['rsedit'] == ""): ?>save<?php else: ?>modify&id=<?php echo $_GET['id']; ?>
<?php endif; ?>"  method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="<?php echo $_GET['id']; ?>
" />
			<li><div class="Left">seo标题：</div><div class="Right"><input type="text" name="title" value="<?php echo $this->_tpl_vars['rseditCol']['seo_title']; ?>
" /></div></li>
