...
/*****************************************************************Sort_排序组 start************/
		...
		$(document).ready(function(){
				...
				$(".Sort .btn a").click(function(){
						...
						$("#tpl_list_body").attr("src","index.php?&col="+col+"&block=list&act=list"+grade+""+label+""+mark+""+sortway+""+title+""+description+""+content+""+type+""+feature+""+style+""+keywords+""+color+""+format+""+attr+"");
