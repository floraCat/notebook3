<?php /* Smarty version 2.6.22, created on 2016-11-21 09:44:16
         compiled from card_parent.html */ ?>
...
?>
				<a href="index.php?col=card_ttl&act=list&parent=<?php echo $this->_tpl_vars['rsList'][$this->_sections['card']['index']]['id']; ?>
&top=<?php echo $_GET['top_id']; ?>
" target="_blank"><?php echo $this->_tpl_vars['rsList'][$this->_sections['card']['index']]['parent']; ?>
</a>
				<?php endfor; endif; ?>
			</div>
		</div>
