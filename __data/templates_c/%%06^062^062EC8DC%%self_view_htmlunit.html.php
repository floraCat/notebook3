<?php /* Smarty version 2.6.22, created on 2014-04-02 13:30:40
         compiled from self_view_htmlunit.html */ ?>
...
.list ol .more .rt img{ width:200px; height:auto;}
</style>
...
?>
			<ol>
				<a class="ttl" target="_blank" href="self_body_2.php?db=htmlunit&id=<?php echo $this->_tpl_vars['rslist'][$this->_sections['list']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['rslist'][$this->_sections['list']['index']]['title']; ?>
				...
				<div class="more">
					...
					<div class="rt">
						<a href="self_body_2.php?db=htmlunit&id=<?php echo $this->_tpl_vars['rslist'][$this->_sections['list']['index']]['id']; ?>
" target="_blank"><img src="<?php echo $this->_tpl_vars['rslist'][$this->_sections['list']['index']]['pic']; ?>
" /></a>
					</div>
				</div>
			</ol>
